return {
  ...
  },
  {
    ...
    config = function()
      vim.api.nvim_set_keymap('n', '<leader>pc', ':Octo pr create<CR>', { noremap = true, silent = true, desc = 'Create PR' })
      vim.api.nvim_set_keymap('n', '<leader>pl', ':Octo pr list<CR>', { noremap = true, silent = true, desc = 'list current Pull requests' })

      require('octo').setup {
        use_local_fs = false, -- use local files on right side of reviews
        enable_builtin = false, -- shows a list of builtin actions when no action is provided
        default_remote = { 'upstream', 'origin' }, -- order to try remotes
        default_merge_method = 'merge', -- default merge method for both `Octo pr merge` and merging from picker; valid values: merge, rebase, squash
        ...
        users = 'mentionable', -- Users for assignees or reviewers. Values: "search" | "mentionable" | "assignable"
        user_icon = ' ', -- user icon
